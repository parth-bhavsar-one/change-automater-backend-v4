    ...
    let content = context.async(async (callback) => {
        ...
        db.query(query)
            .then(async (data) => {
                ...
                // query = ''// JSON.stringify(updatedData.col_data)
                ...
                query += ` WHERE id IN ( SELECT cp_table_connection FROM communication_plan WHERE id = ${properties.id} ) RETURNING *`
                ...
                // res.data = JSON.stringify( updatedDeliverable )
